...
public final class ThreeDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double par0YTicks = -2561.457730503162; // y position of the first parallel encoder (in tick units)
        public double par1YTicks = 2690.8740019340034; // y position of the second parallel encoder (in tick units)
        public double perpXTicks = -2254.8445354808373; // x position of the perpendicular encoder (in tick units)
    }
